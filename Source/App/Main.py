...
# Добавляем родительскую папку в sys.path, чтобы работал импорт BatAnnotation и App
...
class MainWindow(QMainWindow):
    def __init__(self, recording_id: str):
        super().__init__()
        self.setWindowTitle("Bat Annotation Advanced Studio v3.0 (Modular)")
        self.resize(1400, 800)
        
        self.db = SessionLocal()
        tabs = QTabWidget()
        
        self.editor_tab = EditorWidget(self.db, recording_id)
